    ...
    async def generate(
        ...
        **kwargs
        ...
        try:
            ...
            prompt_tokens = data.get("prompt_eval_count", await self.count_tokens(prompt, model_config))
            completion_tokens = data.get("eval_count", await self.count_tokens(content, model_config))
