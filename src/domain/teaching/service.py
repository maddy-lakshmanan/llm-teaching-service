...
class TeachingService:
    ...
    async def ask_question(self, request: TeachingRequest) -> TeachingResponse:
        ...
        if self.monitoring:
            await self.monitoring.record_cache_miss(
                f"teaching:{request.subject.value}"
            )
        ...
        await self.cache.set_teaching_response(request, teaching_response, ttl_seconds=3600)
    ...
    def _post_process_response(self, raw_response: str, request: TeachingRequest) -> str:
        """
